...
const BRAND_NAME = "AceIT";       // ← change app name here
const BRAND_COLOR = "text-indigo-600";  // ← change color here if needed
// To use a custom image logo instead of the Bot icon, replace <Bot .../> in
// the Logo section below with: <img src="/logo.png" alt="logo" className="h-8 w-8" />
// and place your logo.png inside the /public folder.
// ───────────────────────────────────────────────────────────────────────────
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* To use a custom image: replace the Bot icon below with
              <img src="/logo.png" alt="logo" className="h-8 w-8" /> */}
          <Bot className={BRAND_COLOR} size={28} />
          <span className={`text-xl sm:text-2xl font-bold ${BRAND_COLOR}`}>
            {BRAND_NAME}
          </span>
        </Link>
        ...
        <div className="hidden md:block">
          <SignedOut>
            <SignInButton mode="modal">
              <button className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Sign In
              </button>
            </SignInButton>
          </SignedOut>
