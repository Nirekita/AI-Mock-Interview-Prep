...
export const metadata = {
  ...
  title: {
    default: 'AceIT - AI-Powered Interview Preparation',
    template: '%s | AceIT'
  },
  ...
  openGraph: {
    ...
    title: 'AceIT - AI-Powered Interview Preparation',
    description: 'Elevate your interview skills with AI-powered mock interviews. Get personalized coaching, real-time feedback, and boost your confidence.',
    siteName: 'AceIT',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AceIT - Revolutionizing Interview Preparation'
      }
    ]
  },
